...
(function(c) {
    ...
    c.Metro.getOffset = function(a) {
        var b = function(a) {
            a = a.getBoundingClientRect();
            var b = document.body,
                d = document.documentElement,
                c = a.left + (window.pageXOffset || d.scrollLeft || b.scrollLeft) - (d.clientLeft || b.clientLeft || 0);
            return {
                top: Math.round(a.top + (window.pageYOffset || d.scrollTop || b.scrollTop) - (d.clientTop || b.clientTop || 0)),
                left: Math.round(c)
            }
        }, d = function(a) {
                for (var b = 0, d = 0; a;) b += parseInt(a.offsetTop), d += parseInt(a.offsetLeft), a = a.offsetParent;
                return {
                    top: b,
                    left: d
                }
            };
        return a.getBoundingClientRect() ? b(a) : d(a)
    };
...
(function(c) {
    c.widget("metro.hint", {
        ...
        _create: function() {
            ...
            console.log(c.Metro.getOffset(a[0]), a.offset());
            f = 1 < b.length ? b[0] : !1;
